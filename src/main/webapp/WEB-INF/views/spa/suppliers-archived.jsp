<div class="container-fluid py-3" id="itemList">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0"><i class="fas fa-list me-1"></i>Archived Suppliers</h4>
    </div>
...
<script type="text/javascript">
	...
	function loadArchivedSuppliersTable() {

		$.ajax({
			  url: "/backlogtracker/supplier/findAllInActive", 
			  type: "GET",
			  success: function(response) {
		        ...
		        $.each(response, function(index, resp) {
		            var row = '<tr>' +
		                      ...
		                      '<td>' + resp.phone + '</td>' +
		                      '<td>' + resp.email + '</td>' +
		                      '<td><button class="btn btn-sm btn-outline-primary unArchive" data-supplierid="'+resp.id+'">Un Archive</button></td>'+
		                      '</tr>';
